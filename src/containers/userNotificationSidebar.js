...
function RightSidebar() {
  ...
  return (
    ...
    >
      <section
        className={
          "w-52 md:w-4/6  right-0 absolute bg-base-100 h-full shadow-xl delay-400 duration-500 ease-in-out transition-all transform  " +
        ...
        <div className="relative  pb-5 flex flex-col  h-full">
          ...
          <div className="overflow-y-scroll h-full pl-4 pr-4">
            <div className="flex flex-col w-full">
              ...
              {
                {
                  [RIGHT_DRAWER_TYPES.USER_NOTIFICATION]: (
